...
export function detailToFormValues(detail: ProductDetailJson): ProductFormValues {
  ...
  return {
    ...
    cavityOutput: detail.cavityOutput ?? "",
    standardCycleTime: detail.standardCycleTime ?? "",
    targetOutputPerHour: detail.targetOutputPerHour ?? "",
    productStatus: detail.productStatus,
    standardWeightGrams: detail.standardWeightGrams ?? "",
    technicalNotes: detail.technicalNotes ?? "",
    isActive: detail.isActive,
    qualitySpec: {
      weightTolerance: qs?.weightTolerance ?? "",
      thicknessTolerance: qs?.thicknessTolerance ?? "",
      colorTolerance: qs?.colorTolerance ?? "",
      pressureTestRequired: qs?.pressureTestRequired ?? false,
      leakTestRequired: qs?.leakTestRequired ?? false,
      dropTestRequired: qs?.dropTestRequired ?? false,
      visualInspectionRequired: qs?.visualInspectionRequired ?? true,
    ...
    machineSettings: (detail.machineSettings ?? []).map((s) => ({
      ...
      injectionPressure: s.injectionPressure ?? "",
      holdingPressure: s.holdingPressure ?? "",
      coolingTime: s.coolingTime ?? "",
      moldTemperature: s.moldTemperature ?? "",
      shotWeight: s.shotWeight ?? "",
      clampForce: s.clampForce ?? "",
      backPressure: s.backPressure ?? "",
      screwSpeed: s.screwSpeed ?? "",
